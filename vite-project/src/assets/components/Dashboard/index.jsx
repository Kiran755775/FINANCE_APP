        ...
        <>
            <div className="text-white text-center sm:pt-5 sm:mb-5 pt-1 mb-1 ">
                    ...
                    <div className="bg-[#070f2e] sm:h-[46vh] h-[64vh] sm:rounded-b-[30px] rounded-t-2xl rounded-3xl">
                        ...
                        <div className="bg-slate-200 sm:h-[45vh] h-[61.8vh] rounded-b-3xl rounded-t-xl overflow-auto">
                            <div className="px-2">
                                <div className="pt-3">
                            ...
                            <ul className="flex justify-evenly my-2 sm:my-2 w-[100vw] overflow-auto" style={{ overflow: 'auto', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                                
                                {
                                    transactions.map((transaction,index)=>(
                                        <li key={index}><img src="https://www.gravatar.com/avatar/e8bb2833b097f4fdd0029598193c820d?s=64&d=identicon&r=PG" className="rounded-full sm:h-9 h-13"/><h1 className="sm:text-xs text-md text-center">{transaction.inputTextValue}</h1></li>
                                    ))
                                }
                            </ul>
                        ...
                        {transactions.map((transaction, index) => (
                            <li key={index}>
                                <div className="flex justify-evenly items-center mt-4">
                                    ...
                                    <div>
                                        <h1 className="font-bold sm:text-xs text-lg">{transaction.inputTextValue}</h1>
                                        <p className="text-gray-600 font-semibold sm:text-xs text-sm">{currentDateTime}</p>
                                    </div>
                                    <div>
                                        <h1 className="text-red-600 font-bold sm:text-xs pl-12 text-lg">{transaction.inputValue}</h1>
                            ...
                            <div className="bg-[#3273db] flex items-center justify-between sm:w-40 w-48 sm:h-9 h-11 rounded-3xl sm:p-1 p-2  sm:bottom-24 bottom-20 left-24 sm:left-[45vw]  mx-auto fixed">
                                <SiGooglelens className="text-white"/>
                                <h1 className="text-white">New Payment</h1>
                                <Link to="/payments"><FaPlus  className="text-white cursor-pointer"/></Link>
