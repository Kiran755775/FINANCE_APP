...
export default function Dashboard(){
        ...
        <div >
            <div className="text-white text-center sm:pt-5 sm:mb-5  mb-1 ">
                    ...
                    <div className="bg-[#070f2e] sm:h-[46vh] h-[64vh] sm:rounded-b-[30px] rounded-t-2xl rounded-3xl ">
                        ...
                        <div className="bg-slate-200 sm:h-[45vh] h-[85vh] rounded-t-xl ">
                            <div className="px-2">
                                <div className="pt-3">
                            ...
                            <ul className="flex justify-evenly items-start my-2 sm:my-2 w-full overflow-auto" style={{ overflow: 'auto', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
    {transactions.map((transaction, index) => (
        <li key={index} className="flex flex-col items-center w-32">
            ...
            <h1 className="text-center text-sm mt-1 truncate" style={{ width: '100%' }}>{transaction.inputTextValue}</h1>
        </li>
    ))}
</ul>
                            ...
                            <h1 className="text-[#070f2e] font-bold px-4  text-2xl">Current Activity</h1>
                            ...
                            <ul className=" overflow-scroll h-[40vh]">
                        {transactions.map((transaction, index) => (
                            <li key={index}>
