        ...
        <div className="flex justify-evenly">
            <div className="bg-gradient-to-b from-[#04214a] via-[#0f3973] to-[#050f1f] sm:h-[80vh]  relative sm:top-24 sm:w-[18vw] rounded-[30px]    w-[100vw]  h-[100vh] ">
                <div>
                    ...
                    <img src="https://shivalikbank.com/public/frontendassets/images/dabit-card2.png" className=" sm:h-72  h-[40vh] w-full  object-cover mt-10 sm:mt-1"/>
                    ...
                    <Link to="/overview">
                    <button className="text-center bg-white text-[17px] text-blue-950 w-11/12 h-14 sm:h-10 mx-auto  rounded-3xl my-1 font-semibold cursor-pointer"> Lets Go! </button>
                    </Link>
                    </div>
